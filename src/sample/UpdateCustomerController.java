...
public class UpdateCustomerController implements Initializable {
    ...
    @FXML
    public static void initSelectedCustomer(Customers customer) throws SQLException {
        selectedCustomer = customer;
        selectedDivisionID = selectedCustomer.getDivisionID();
        selectedDivision = FirstLevelDivisionsQuery.getFirstLevelDivisionByID(selectedDivisionID);
        selectedCountryID = FirstLevelDivisionsQuery.getCountryByID(selectedDivisionID);
        selectedCountry = CountriesQuery.getCountryByID(selectedCountryID);
    }
...
//    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if (selectedCustomer != null) {
            ...
            stateComboBox.setValue(selectedDivision);
