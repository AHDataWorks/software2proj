...
public abstract class AppointmentsQuery {
    ...
    public static void updateAppointment(String title, String description, String location, String type,java.sql.Timestamp start,java.sql.Timestamp end,java.sql.Timestamp createDate, String createdBy,java.sql.Timestamp lastUpdate,String lastUpdatedBy, int customerID,int userIDNumber,int contactID,int apptID) throws SQLException {
